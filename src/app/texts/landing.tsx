...
I've fine-tuned multiple small (1M- 125M parameters) LLMs to create stories in the greentext style. Interestingly, the bigger ones do not automatically perform better. You can tune a lot of the performance with the training data quantity specificity.

Click "Generate (model name, dataset)" below to try how the models and training procedures compare and can indicate the quality of each generation.
